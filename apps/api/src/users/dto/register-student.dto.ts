...
export class RegisterStudentDto {
  ...
  @ApiProperty({
    example: 'clxxxxxxxxxxxxx',
    description: 'ID del turno preferido',
  })
  @IsString()
  @IsNotEmpty()
  turnId: string;
  ...
  @ApiProperty({
    example: 'clxxxxxxxxxxxxx',
    description:
      'ID de la sección (opcional, si no se especifica se auto-asigna)',
    required: false,
  })
  @IsString()
  @IsOptional()
  ...
  @ApiProperty({
    description: '¿El estudiante ya realizó el primer pago al matricularse?',
    required: false,
    default: false,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    example: 'Efectivo',
    description: 'Método del primer pago',
    required: false,
  })
  @IsString()
  @IsOptional()
  ...
  @ApiProperty({
    ...
    description: 'Referencia del primer pago',
    required: false,
  })
  @IsString()
  @IsOptional()
  ...
  @ApiProperty({
    ...
    description: 'Notas del primer pago',
    required: false,
  })
  @IsString()
  @IsOptional()
  ...
  @ApiProperty({
    description: 'ID público en Cloudinary (número de documento)',
    required: false,
  })
  @IsString()
  @IsOptional()
